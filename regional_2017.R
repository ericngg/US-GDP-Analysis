...
#industry interested
industry_filter <- c("11, 21", 22, 23,
                     "321,327-339", "311-316,322-326",
                     42, "44-45", "48-49",
                     51, 52, 53, "54, 55, 56",
                     61, 62, 71, 72, 81)
...
all_industry_data <- data.frame(Geo, public_filter("  Utilities"),
                                ...
                                public_filter("  Transportation and warehousing"),
                                public_filter("  Information"),
                                public_filter("   Finance and insurance"),
                                public_filter("   Real estate and rental and leasing"),
                                public_filter("  Professional and business services"),
                                public_filter("   Educational services"),
                                public_filter("   Health care and social assistance"),
                                public_filter("   Arts, entertainment, and recreation"),
                                public_filter("   Accommodation and food services"),
                                public_filter("  Other services (except government and government enterprises)"),
                                public_filter("Natural resources and mining"),
                                public_filter(" Government and government enterprises"))

####Top 10 industry plot
top10_data <- plot_ly(all_industry_data,
                      x = ~region,
